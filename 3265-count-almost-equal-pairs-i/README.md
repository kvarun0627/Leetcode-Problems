<h2><a href="https://leetcode.com/problems/count-almost-equal-pairs-i/?envType=problem-list-v2&envId=sorting">3265. Count Almost Equal Pairs I</a></h2><h3>Medium</h3><hr><p>You are given an array <code>nums</code> consisting of positive integers.</p>
